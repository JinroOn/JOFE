      ...
      <section className="relative pt-24 pb-32 px-4 sm:px-8 overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          <div className="flex-1 text-center lg:text-left z-10">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-7xl font-extrabold text-primary leading-tight tracking-tight mb-8 font-headline">
              나의 가능성에 맞는<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary to-primary-container">전공을 찾아드려요</span>
            </h1>
            <p className="text-base sm:text-xl text-on-surface-variant leading-relaxed mb-10 max-w-2xl font-body">
      ...
      <section className="py-24 px-4 sm:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-outline-variant/20 rounded-brand overflow-hidden cloud-shadow">
            ...
            <div className="bg-primary-container p-6 sm:p-10 md:p-12">
